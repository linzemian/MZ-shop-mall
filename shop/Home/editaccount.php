...
?>
		<form action="action.php?a=editaccount" method="post" enctype="multipart/form-data">
			<div class="topWrap">
				...
				<div class="top-rightWrap">
					...
					<div id="nickNameCon" class="lineWrap modify_content nickNameCon" style="display: none">
						<div style="*display:inline" novalidate="novalidate">
							<div class="lineWrap">
								<input type="text" value="" name="nickname" id="newnickName" class="normalInput">
							</div>
							<div class="clear"></div>
							<div class="edit">
								<a class="fullBtnBlue save_div fleft" id="editSave">保存</a>
								<a class="fullBtnGray cancel_div fleft" id="editCancel">取消</a>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					<div class="lineWrap grayTip nameWrapTop" id="getaccountNameWrap">
						...
						<!-- 编辑头像：<input type="file" name="pic" enctype="myltipart/div-data"> -->
						</label>
						<input type="hidden" value="lzmlrl" id="memberFlyme">
					</div>
					...
					<div id="setaccount" class="modify_content" style="display: none">
						...
						<div>
							...
							<div class="clear"></div>
							<div class="fBtnleft">
								<a class="fullBtnBlue save_div fleft" id="newSave">保存</a>
								<a class="fullBtnGray cancel_div fleft" id="newCancel">取消</a>
								<div class="clear"></div>
							</div>
						</div>
					</div>
			...
			<div class="mainWrap">
				...
				<div class="bodyWrap">
					<div id="pwdWrap" class="lineWrap pwdWrapTop">
						<div class="item-right">
							<a class="linkABlue modify" id="modifyPassword"></a>
						</div>
						<div class="item-left">新密码</div>
						<div class="item-middle">
							<input type="password" placeholder="不填时则默认使用原密码" name="pwdpwd" value="" style="height:30px;width:250px;border:1px solid #999;">
						</div>
						<div class="clear"></div>
					</div>
					<div id="pwdWrap" class="lineWrap pwdWrapTop">
						...
						<div class="item-middle">
							<input type="password" placeholder="不填时则默认使用原密码" name="pwdpwd2" value="" style="height:30px;width:250px;border:1px solid #999;">
						</div>
						<div class="clear"></div>
					</div>
					<!-- 修改密码 验证密码 -->
					<div id="changePasswordWrapFirst" class="grayBorderT grayBorderB modify_content" style="display:none;">
							...
							<div class="setQuestion-bodyWrap" novalidate="novalidate">
									<div class="lineWrap">
										<div class="leftWrap">
									...
									<div class="lineWrap">
										...
										<a class="fullBtnBlue save_div fleft" id="ce-u-pwd-phone-check">下一步</a>
										<a class="fullBtnGray cancel_div fleft" id="ce-u-pwd-phone-cancel">取消</a>
										<div class="clear"></div>
									</div>
										<div class="clear"></div>
							</div>
					...
					<div id="changePasswordWrap" class="grayBorderB modify_content" style="display:none;">
						...
						<div class="cEmail-bodyWrap" enctype="application/x-www-div-urlencoded" novalidate="novalidate">
							<div class="lineWrap">
								<div class="leftWrap">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a href="javascript:;" class="fullBtnBlue save_div fleft" id="ce-u-pwdsave">保存</a>
								<a href="javascript:;" class="fullBtnGray cancel_div fleft" id="ce-u-pwdcancel">取消</a>
								<div class="clear"></div>
							</div>
						</div>
					</div>
					<div id="emailWrap" class="lineWrap">
						...
						<div class="item-right" style="display:none;">
							<a id="emailbindEdite"  class="linkABlue modify" data-type="modify"></a>
						</div>
						<!-- end if -->
						<!--if已验证  -->
						<div class="item-right">
							<a id="emailEdite"class="linkABlue modify" data-type="modify"></a>
						</div>
						<!-- end if -->
						<!--if-->
						<div class="item-right" style="display:none;">
						...
						<div class="item-middle" id="email-item-middle1">
							<span id="current_email" class="email bold"><input type="text" placeholder="请输入15位一下QQ号码" maxlength="15" minlength="2" name="qqqq" value="<?=$arr['qq']?>" style="height:30px;width:250px;border:1px solid #999;"></span><br>
						</div>
						<!-- end if -->
						<!--if-->
					...
					<div id="bindEmail-step1" class="grayBorderT grayBorderB modify_content " style="display:none;">
						...
						<div class="cEmail-bodyWrap" novalidate="novalidate">
							<div class="lineWrap">
								<div class="leftWrap">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a class="fullBtnBlue ce-u-save save_div fleft" id="bindEmail-step1-savenext">下一步</a>
								<a class="fullBtnGray ce-u-cancel cancel_div fleft" id="bindEmail-step1-savenextcancel">取消</a>
								<div class="clear"></div>
							</div>
									<div class="clear"></div>
						</div>
					...
					<div id="bindEmailWrap" class="grayBorderT grayBorderB modify_content" style="display: none;">
						...
						<div class="bindEmail-bodyWrap" novalidate="novalidate">
							<div class="lineWrap">
								<div class="leftWrap">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a class="fullBtnBlue ce-u-save save_div fleft" id="ce-u-bindsave">保存</a>
								<a class="fullBtnGray ce-u-cancel cancel_div fleft" id="ce-u-bindcancel">取消</a>
								<div class="clear"></div>
							</div>
						</div>
					</div>
					<div id="changeEmailWrap-unactiveone" class="grayBorderT grayBorderB modify_content " style="display:none;">
						...
						<div class="cEmail-bodyWrap" novalidate="novalidate">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a class="fullBtnBlue ce-u-save save_div fleft" id="ce-u-savenext">下一步</a>
								<a class="fullBtnGray ce-u-cancel cancel_div fleft" id="ce-u-savenextcancel">取消</a>
								<div class="clear"></div>
							</div>
									<div class="clear"></div>
						</div>
					...
					<div id="changeEmailWrap-unactive" class="grayBorderT grayBorderB modify_content " style="display:none;">
						...
						<div class="cEmail-bodyWrap" novalidate="novalidate">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a class="fullBtnBlue ce-u-save save_div fleft" id="ce-u-save">保存</a>
								<a class="fullBtnGray ce-u-cancel cancel_div fleft" id="ce-u-cancel">取消</a>
								<div class="clear"></div>
							</div>
						</div>
					</div>
					...
					<div id="changeEmailWrap-activeone" class="grayBorderT grayBorderB modify_content" style="display:none;">
						...
						<div class="cEmail-bodyWrap" novalidate="novalidate">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a class="fullBtnBlue ce-u-save save_div fleft" id="ce-u-activenext">下一步</a>
								<a class="fullBtnGray ce-u-cancel cancel_div fleft" id="ce-u-activecancel">取消</a>
								<div class="clear"></div>
							</div>
						</div>
					</div>
					<div id="changeEmailWrap-active-two" class="grayBorderT grayBorderB modify_content" style="display:none;">
						...
						<div class="cEmail-bodyWrap" novalidate="novalidate">
							...
							<div class="lineWrap">
								<label class="fleft">&nbsp;</label>
								<a class="fullBtnBlue save_div fleft" id="ce-u-activesave">保存</a>
								<a class="fullBtnGray cancel_div fleft" id="ce-u-activecanceltwo">取消</a>
								<div class="clear"></div>
							</div>
						</div>
					</div>
					<div id="telWrap" class="lineWrap">
						<!--if-->
						<div class="item-right">
							<a id="editMobile"  class="linkABlue modify"></a>
						</div>
						<!-- end if -->
						<!--if-->
						<div class="item-right" style="display:none;">
						...
						<div class="item-middle" id="telModify">
							<span id="current_phone" class="bold"><input type="file" name="pic"></span>
							<br>
						</div>
					...
					<div id="setQuestion-stepOne" class="grayBorderT grayBorderB modify_content" style="display:none;">
						...
						<div class="setQuestion-bodyWrap" novalidate="novalidate">
								...
								<div class="lineWrap">
									<label class="fleft">&nbsp;</label>
									<a class="fullBtnBlue save_div fleft" id="setQuestionSave">下一步</a>
									<a class="fullBtnGray cancel_div fleft" id="setQuestionCancel">取消</a>
									<div class="clear"></div>
								</div>
									<div class="clear"></div>
						</div>
				...
				<div style="float:left">
                    <input type="submit" value="提交资料" class="go">
                    <a href="./personal.php" class="go">返回个人中心&gt;&gt;</a>
                </div> 
                <input type="hidden" name="username" value="<?=$arr['username']?>">
            </form>    
		</div>
	</div>
